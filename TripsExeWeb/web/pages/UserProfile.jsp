    ...
    <body class="bg-[#191a1f]">
        ...
        <div class="px-[128px] pt-20 text-white min-h-fit flex">
            <main class="w-4/6 mr-6">
                <div class="mb-5 border border-[#202227] bg-[#141519] rounded-md">
                    ...
                    <div class="px-5 flex flex-row">                    
                        ...
                        <div class="ml-auto mt-3">
                            <div>                            
                                <button class="flex items-center px-4 py-2 rounded-lg bg-[#d6293e1a] text-sm font-medium text-[#d6293e] pointer hover:text-white hover:bg-[#D6293E] hover:cursor-pointer duration-300">
                    ...
                    <div class="mt-4 pt-2 px-5">
                        <ul class="flex flex-row tab-list">
                            <li id="feed-tab" class="px-4 py-3 cursor-pointer selected border-b-[3px] border-[#0f6fec]">
                                <a class="text-base font-semibold text-[#0f6fec]  duration-200">Feed</a>
                            </li>
                            <li id="connections-tab" class="px-4 py-3 cursor-pointer ">
                                <a class="text-base font-semibold text-gray-300 hover:text-[#0f6fec] duration-200">Friends</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div id="friends-content" class="friends-content hidden">
                    <div class="p-5 mb-5 border border-[#202227] bg-[#141519] rounded-md">
                        <h3 class="text-lg font-bold mb-2">Friends List</h3>
                        <div class="mt-4 grid grid-cols-2 grid-rows-4 gap-6">
                            <div class="flex items-center space-x-3 mb-4">
                                ...
                                <div class="flex flex-row gap-2">
                                    <button class="flex items-center px-3 py-2 rounded bg-[#d6293e1a] text-sm text-[#d6293e] pointer hover:text-white hover:bg-[#D6293E] hover:cursor-pointer duration-300">
                                        Remove
                                    </button>
                                    <button class="flex items-center px-3 py-2 rounded bg-[#0f6fec1a] text-sm text-[#0f6fec] pointer hover:text-white hover:bg-[#0f6fec] hover:cursor-pointer duration-300">
                                        Message
                                    </button>
                                </div>
                            </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                function clearSelected() {
                    tabs.forEach(tab => {
                        tab.classList.remove("selected", "border-b-[3px]", "border-[#0f6fec]");
                        const link = tab.querySelector("a");
                        if (link) {
                            link.classList.remove("text-[#0f6fec]");
                            link.classList.add("text-gray-300");
                            link.classList.add("hover:text-[#0f6fec]");
                        } else {
                            console.warn(`No <a> tag found in tab ${tab.id}`);
                        }
                    });
                }
                ...
                tabs.forEach(tab => {
                    tab.addEventListener("click", () => {
                        clearSelected();
                        tab.classList.add("selected", "border-b-[3px]", "border-[#0f6fec]");
                        const link = tab.querySelector("a");
                        if (link) {
                        ...
                        if (tab.id === "feed-tab") {
                            showFeedContent();
                        } else if (tab.id === "connections-tab") {
                            showFriendsContent();
                        }
                    });
                });
