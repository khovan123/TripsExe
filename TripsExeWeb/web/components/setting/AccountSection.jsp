...
<main>
    <c:if test="${empty user}">
        <c:redirect url="/TripsExeWeb/pages/SignIn.jsp" />
    </c:if>
    <form method="POST" action="/TripsExeWeb/update-info-me">
        <section id="account-settings" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input required type="text" value="${user.username}" class="w-full p-2 bg-[#191A1F] text-white rounded-md focus:outline-none border-2 border-[#303135] focus:border-[#0F6FEC]" name="username">
                </div>
                <div>
                    <label class="block text-gray-400 mb-1">Birthday</label>
                    <input required type="date" value="${user.dob}" class="w-full p-2 bg-[#191A1F] text-white rounded-md focus:outline-none border-2 border-[#303135] focus:border-[#0F6FEC]" name="dob">
                </div>
            </div>

            <div class="mb-4 flex items-center custom-checkbox">
                <input required type="checkbox" name="allowTeam" value="true" <c:if test="${true}">checked</c:if> class="mr-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input required type="text" value="${user.phoneNumber}" class="w-full p-2 bg-[#191A1F] text-white rounded-md focus:outline-none border-2 border-[#303135] focus:border-[#0F6FEC]" name="phoneNumber">
                </div>
                <div>
                    <label class="block text-gray-400 mb-1">Email</label>
                    <input required type="email" value="${user.email}" class="w-full p-2 bg-[#191A1F] text-white rounded-md focus:outline-none border-2 border-[#303135] focus:border-[#0F6FEC]" name="email">
                </div>
            </div>
